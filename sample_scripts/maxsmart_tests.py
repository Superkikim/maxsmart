...
def plot_vectorial_graph(port_mapping, data):
    ...
    input("Press Enter to continue...")  # This will keep the plot open until Enter is pressed
...
def main():
    ...
    if devices:
        ...
        port_mapping = selected_strip.retrieve_port_names()  # Retrieve current port names
        print(port_mapping)
